...
@pytest.mark.parametrize("file_name,tag_family_name,expected_num",
                         [('tests/data/t36h11_2bit_margin.jpg', 't36h11', 36),
                          ('tests/data/t36h11_1bit_margin.png', 't36h11b1', 154)])
